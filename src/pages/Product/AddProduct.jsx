  ...
  <div className="card">
    ...
    <div className="card-body card-block">
      ...
      >
        ...
        <div className="row form-group">
          <div className="col col-md-3">
            <label htmlFor="email-input" className=" form-control-label">
              Email Input
            </label>
          </div>
          <div className="col-12 col-md-9">
        ...
        <div className="row form-group">
          <div className="col col-md-3">
            <label htmlFor="password-input" className=" form-control-label">
              Password
            </label>
          </div>
          <div className="col-12 col-md-9">
        ...
        <div className="row form-group">
          <div className="col col-md-3">
            <label htmlFor="disabled-input" className=" form-control-label">
              Disabled Input
            </label>
          </div>
          <div className="col-12 col-md-9">
        ...
        <div className="row form-group">
          <div className="col col-md-3">
            <label htmlFor="selectLg" className=" form-control-label">
              Select Large
            </label>
          </div>
          <div className="col-12 col-md-9">
        ...
        <div className="row form-group">
          <div className="col col-md-3">
            <label htmlFor="multiple-select" className=" form-control-label">
              Multiple select
            </label>
          </div>
